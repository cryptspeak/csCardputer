...
| [encryption-known-destinations.md](encryption-known-destinations.md) | At-rest encryption of microReticulum's own `known_destinations` table (announced peer names cached outside the app's contacts/name-cache files) — `KnownDestEncryption` |
